// Deduplicate financing plans to fix the issue with duplicate plans in the UI
const { executeQuery } = require('../lib/db');

async function deduplicateFinancingPlans() {
  try {
    console.log('Starting financing plans deduplication...');
